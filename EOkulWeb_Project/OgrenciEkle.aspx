<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="OgrenciEkle.aspx.cs" Inherits="EOkulWeb_Project.OgrenciEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" Text="Öğrenciyi Kaydet" CssClass="btn btn-info" OnClick="Button1_Click" />
