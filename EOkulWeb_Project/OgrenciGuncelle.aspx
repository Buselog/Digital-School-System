<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="OgrenciGuncelle.aspx.cs" Inherits="EOkulWeb_Project.OgrenciGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" Text="Öğrenci Bilgilerini Güncelle" CssClass="btn btn-primary" OnClick="Button1_Click" />
